...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZmVybmFuZG9jdXRpcmUiLCJhIjoiY2tnN2ExZGo3MDF4YzJzbWtnbXJlbWszZyJ9.BaGn2X3W2ENGBDNFgvfwmw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/fernandocutire/ckg7caoc006au19mpyp6zb93v',
    scrollZoom: false
  });
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logged in succesfully :D');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status = 'success') {
              (0, _alerts.showAlert)('success', 'Bye!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
var stripe = Stripe('pk_test_51Hq8SDBNvSeHqwTMrNf5OKrg5ksLf7fk0eYzMwGHvrkyLhMKnMoAQvFNvjUFPC0otGNm6QDl7nswNyuOnVg0cYs900xD61Oeaq');
